 ...
 <section id="hero" class="d-flex align-items-center">
    <div class="container">
      ...
      <h2>We are team of qualified and licensed medical practioners attending to patients.</h2>
      <a href="/accounts/login" class="btn-get-started scrollto">Get Started</a>
    </div>
  </section>
				...
				<div class="col-lg-4 d-flex align-items-stretch">
					<div class="content">
						...
						<div class="text-center">
							<a href={null} class="more-btn">Learn More <i class="bx bx-chevron-right" /></a>
						</div>
					</div>
				</div>
